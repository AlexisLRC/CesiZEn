    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-xl hover:shadow-2xl transition duration-300 border-l-4 border-cesi-green">
                    <div class="p-6">
            ...
            <div class="bg-white p-6 shadow-lg rounded-xl border-t-4 border-cesi-yellow max-w-md">
                @if($myExercise)
